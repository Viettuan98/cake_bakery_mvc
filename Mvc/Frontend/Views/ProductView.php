    ...
    <?php foreach ($data as $rows): ?>
        <div class="col-lg-4 col-md-4 col-6">
            <div class="cake_feature_item">
                <a href="index.php?controller=Product&action=detail&type=<?php echo $rows->id_type;?>&id=<?php echo $rows->id;?>">
                    <div class="cake_img">
...
<div class="product_pagination">
    ...
    <div class="middle_list">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <?php $id = isset($_GET["id"])&&is_numeric($_GET["id"])?$_GET["id"]:0; for($i = 1; $i <= $numPage; $i++): ?>
                <li class="page-item active"><a class="page-link" href="index.php?controller=Product&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
