            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="Assets/Backend/Admin/images/logo.svg">
                </div>
                <h4>Xin Chào!!!</h4>
                <h6 class="font-weight-light">Đăng nhập để tiếp tục.</h6>
                <form class="pt-3" method="post" action="index.php?area=Backend&controller=Login&action=doLogin">
                  <div class="form-group">
                    <input type="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email Đăng Nhập" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="mt-3">
                    <input type="submit" value="Đăng Nhập"class="form-control btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">
                    
                  </div>
                  <div>TK: admin@gmail.com ||| MK:12346</div>
