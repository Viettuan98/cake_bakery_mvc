<?php 
	//load file model
	include "Mvc/Backend/Models/ProductsModel.php";
	class ProductsController extends Controller{
		...
		public function index(){
			...
			return $this->renderHTML("Mvc/Backend/Views/ProductsView.php",array("data"=>$data,"numPage"=>$numPage));
		}
		//edit
		public function edit(){
			...
			//goi view
			$this->renderHTML("Mvc/Backend/Views/AddEditProductsView.php",array("record"=>$record,"formAction"=>$formAction));
		}
		//do edit
		...
		public function add(){
			...
			//goi view
			$this->renderHTML("Mvc/Backend/Views/AddEditProductsView.php",array("formAction"=>$formAction));
		}
		//do add
